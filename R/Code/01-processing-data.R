...
### Collating useful new-ish commands ----
...
# Tidying data
secondary_data_pivot <- secondary_data %>%
...
write_dta(secondary_data_pivot, file.path(data_path, "Intermediate/TZA_amenity_tidy.dta"))
